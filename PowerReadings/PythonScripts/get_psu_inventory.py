        ...
        if response_chassis_url.status == 200:
            for request in response_chassis_url.dict['Members']:
                ...
                if response_url.status == 200:
                    ...
                    if len(response_chassis_url.dict['Members']) > 1 and (not response_url.text or "Links" not in response_url.dict or "ComputerSystems" not in response_url.dict["Links"]):
                        continue
