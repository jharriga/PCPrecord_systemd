...
# JTH - success. Print 'the_url'
##                                    the_url=power_url + "PowerControl" + "PowerMetrics"
##                                    print("key: ", key, the_url)
##                                    print("key: ", key, response_power_url)
...
# JTH find way to add the URL HERE!
                result["url"] = request_url           # JTH - DISPLAY
            else:
...
if __name__ == '__main__':
    ...
    if result['ret'] is True:
        ...
        sys.stdout.write(json.dumps(result['url'], sort_keys=True, indent=2) + '\n')
