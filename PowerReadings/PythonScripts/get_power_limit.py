...
def get_power_limit(ip, login_account, login_password):
    """Get power limit
        ...
        :returns: returns Get power limit result when succeeded or error message when failed
        """
...
if __name__ == '__main__':
    ...
    # Get power limit and check result
    result = get_power_limit(ip, login_account, login_password)
